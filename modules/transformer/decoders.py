...
from modules.transformer.utils import sinusoid_encoding_table, PositionWiseFeedForward
from modules.containers import Module, ModuleList
...
class MeshedDecoder(Module):
    ...
    def forward(self, input, encoder_output, mask_encoder):
        ...
        return F.softmax(self.fc(out), dim=-1), out
